    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 8:
          ...
          (0, _alert.showAlert)('error', 'Error Occurred !');
...
},{"axios":"../../node_modules/axios/index.js","./alert.js":"alert.js"}],"../../node_modules/bingmaps/index.js":[function(require,module,exports) {
/// <reference path="types/MicrosoftMaps/Microsoft.Maps.All.d.ts"/>
},{}],"../../node_modules/bing-maps-loader/dist/index.js":[function(require,module,exports) {
"use strict";
...
exports.getCallBack = void 0;
require("bingmaps");
var _bingMapsLoader = require("bing-maps-loader");
...
function _arrayWithHoles(arr) { if (Array.isArray(arr)) return arr; } // <--  Microsoft supported types library for Microsoft.Maps
var API_KEY = 'AjxnDjagPGP47k7cMNdFsrxgsumhCoo5swD0z5lnNNilc4rdhdo6QkRjtxug0smY';
(0, _bingMapsLoader.initialize)(API_KEY);
var getCallBack = function getCallBack(locations) {
  var _locations$0$coordina = _slicedToArray(locations[0].coordinates, 2),
    lng = _locations$0$coordina[0],
    lat = _locations$0$coordina[1];
  _bingMapsLoader.whenLoaded.then(function () {
...
},{"bingmaps":"../../node_modules/bingmaps/index.js","bing-maps-loader":"../../node_modules/bing-maps-loader/dist/index.js"}],"updateSettings.js":[function(require,module,exports) {
"use strict";
  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(tourId) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          stripe = Stripe('pk_test_51NPK87SEy00QzfQlZbKvXgHEQtmQWCqkojn82LYLYC5NvC4mPNE4HjUUQ6MwnTl998pWK2uwC468eon9gq8wjVyQ00B0DC7cRC'); // 1. ) Get checkout session from the API
          _context.next = 4;
          return (0, _axios.default)({
            method: 'GET',
...
function _arrayLikeToArray(arr, len) { if (len == null || len > arr.length) len = arr.length; for (var i = 0, arr2 = new Array(len); i < len; i++) arr2[i] = arr[i]; return arr2; } /** This file is use to get data from user interface , and delegate it to the modules(e.g map , login etc )  */
// PROTECTOR
/**
 *
...
var formUserPwd = document.querySelector('.form-user-settings');
...
if (formLogin) {
  ...
  formLogin.addEventListener('submit', function (e) {
    ...
    var _ref = _toConsumableArray(removeWhiteSpace(email, password));
    email = _ref[0];
    password = _ref[1];
...
if (formUserData) {
  formUserData.addEventListener('submit', function (e) {
    ...
    // REMOVE WHITESPACE
    var _ref2 = _toConsumableArray(removeWhiteSpace(document.getElementById('name').value, document.getElementById('email').value)),
      name = _ref2[0],
      email = _ref2[1];
...
if (formUserPwd) {
  formUserPwd.addEventListener('submit', /*#__PURE__*/function () {
    var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(e) {
      var currentPassword, password, confirmedPassword, _ref4;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            e.preventDefault();
            ...
            confirmedPassword = document.getElementById('password-confirm').value; // REMOVE WHITE SPACE
            ...
            _ref4 = _toConsumableArray(removeWhiteSpace(currentPassword, password, confirmedPassword));
            currentPassword = _ref4[0];
            password = _ref4[1];
            confirmedPassword = _ref4[2];
            _context.next = 11;
